	    ...
	    <div class="container-fluid">
    		<div class="row">
    			...
    			<div class="col-xs-3 col-sm-4 text-right" id="header-right" >
                    ...
                    @if($cart)
                    <a href="{{ route('cart') }}" class="header-cart">Cart</a>
                    @endif
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="login__contact_hide_show">
                                        ...
                                        @if(auth()->user())
                                                <a href="{{ route('account.orders') }}" class="login_r_button login_r_button_contact">
                                                    {{ __('Orders') }}
                                                </a>
                                        @endif
                                        ...
                                        <a href="#" onclick="iccustomfun('join_gallery')" class="login_r_button login_r_button_contact" data-toggle="modal" data-target="#join_gallery">
                                            {{ __('Join gallery (free)') }}
                                        </a>
                                        <?php if($userId && auth()->user() &&  auth()->user()->role == 'admin'){ ?>
