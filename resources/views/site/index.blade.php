        ...
        <div class="homepage-filter-bar">
            <div class="row">
                <div class="mob-space" style="height: 34px;">
                    <div class="@if($filter_value !='All') product-filter-disable subcategory-name @else filter-gallery-toggle @endif" @if($filter_value !='All') style="padding-right:10px;" @endif data-type="{{$filter_value}}" data-filter-type="type"> @if($filter_value !='All') @if($subcategories && count($subcategories) > 0) 
