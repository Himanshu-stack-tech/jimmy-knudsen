            ...
            <div class="row slider-row">
                <div class="col-xl-9 col-md-9 slider-main-lg slider-main-product">
                    ...
                    <div class="info_detail">
                        <a href="{{ url('') }}" class="product_details_page__btn prozak_family h3" id="close_side2">
                ...
                <div class="col-xl-3 col-md-3 side_bar side-bar-right sidebar-main-lg">
                    ...
                    <a href="{{ url('') }}" class="product_details_page__btn prozak_family h3" id="close_side1">
                    ...
                    <div class="sidebar__buttons">
                        ...
                        <?php } ?>
                            ...
                            @if ((is_null($product_details->price)) ||  ($product_details->price=='') ||  ($product_details->price=='0') || $product_details->sale == 'no')

                            @elseif(!auth()->check())
{{--                                <button class="detailed-button btn_add_to_card" data-toggle="modal" data-target="#exampleModal">Buy for {{ $product_details->currency.' '.$product_details->price }}</button>--}}
                            @else
                                @if(auth()->user() && auth()->user()->id != $product_details->user->id)
{{--                                <button--}}
{{--                                    data-id="{{ $product_details->id }}"--}}
{{--                                    data-user-id="{{ auth()->user()->id }}"--}}
{{--                                    data-price="{{ $product_details->price }}"--}}
{{--                                    data-size="{{ $product_details->package_size ?? '-'}}"--}}
{{--                                    data-weight="{{ ($product_details->package_weight) ? $product_details->package_weight : '-' }}"--}}
{{--                                    data-quantity="{{ $product_details->quantity ?? '1' }}"--}}
{{--                                    data-seller-id="{{ $product_details->shop_profile_id }}" class="detailed-button btn_add_to_card">Buy for {{ $product_details->currency.' '.$product_details->price }}</button>--}}
